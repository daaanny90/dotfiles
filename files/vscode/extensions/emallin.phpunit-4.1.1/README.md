...
![vscode-phpunit-demo](https://github.com/elonmallin/vscode-phpunit/raw/master/images/vscode-phpunit-demo.gif)
...
See the configuration section in [package.json](https://github.com/elonmallin/vscode-phpunit/blob/master/package.json) for all values and their descriptions (highly recommened if you need advanced functionality).
...
![vscode-phpunit-test-function](https://github.com/elonmallin/vscode-phpunit/raw/master/images/vscode-phpunit-test-function.gif)

* **Test a class**: Place cursor on class name and run.

![vscode-phpunit-test-class](https://github.com/elonmallin/vscode-phpunit/raw/master/images/vscode-phpunit-test-class.gif)

* **Pick test from a list**: Place cursor anywhere in class except on class name or on a function and run.

![vscode-phpunit-quick-pick](https://github.com/elonmallin/vscode-phpunit/raw/master/images/vscode-phpunit-quick-pick.gif)

* **Test everything according to --configuration**: Close editor window and run.

![vscode-phpunit-test-all](https://github.com/elonmallin/vscode-phpunit/raw/master/images/vscode-phpunit-test-all.gif)

* **Test everything in a directory**: Open a file in the directory to test and run the `PHPUnit Test Directory` command.

![vscode-phpunit-test-directory](https://github.com/elonmallin/vscode-phpunit/raw/master/images/vscode-phpunit-test-directory.gif)
