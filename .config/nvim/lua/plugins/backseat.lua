return {
  ...
  config = function()
    require('backseat').setup {
      ...
      openai_api_key = 'sk-MvD0AdZieOI76N-lL6xMEjNgfewg2WILVNMPaGjrz6T3BlbkFJ0Jlqgw_sqFOuQt9xuAAJudySmwCiWawRpVHqB7GwQA', -- Get yours from platform.openai.com/account/api-keys
